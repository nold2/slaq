...
var $author$project$Main$ParseMessage = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$Message$decode = A3(
	...
	A3(
		...
		A3(
			...
			'user',
			$elm$json$Json$Decode$string,
			$elm$json$Json$Decode$succeed($author$project$Message$Message))));
...
var $author$project$Port$Socket$receiveMessage = _Platform_incomingPort('receiveMessage', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Port$Socket$isConnected($author$project$Main$ConfirmConnection),
				$author$project$Port$Socket$receiveMessage(
				A2(
					$elm$core$Basics$composeL,
					$author$project$Main$ParseMessage,
					$elm$json$Json$Decode$decodeValue($author$project$Message$decode)))
			]));
};
										...
										n: A2(
											...
											_List_fromArray(
												[
													...
													'Error occurred at' + $elm$core$String$fromInt(index))
												]))
									}),
								$elm$core$Platform$Cmd$none);
						case 3:
...
var $author$project$Main$chatView = function (model) {
	var messagesView = A2(
		...
		function (msg) {
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('bubble__container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('bubble-name')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('bubble-time')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('bubble-message')
							]),
						_List_fromArray(
							[
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('chat__container')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('top_nav')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('greetings__container')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('greetings'),
										$elm$html$Html$Attributes$class('greetings-name')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('greetings-connection')
									]),
								_List_Nil)
							])),
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('chat-window'),
						$elm$html$Html$Attributes$class('chat-window')
					]),
				messagesView),
				A2(
				$elm$html$Html$form,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('send-chat'),
						$elm$html$Html$Attributes$class('chat-box__container'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for('chat-box')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$input,
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('chat-submit__button')
							]),
						_List_Nil)
					]))
			]));
...
var $author$project$Main$SubmittedForm = {$: 2};
			...
			[
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$type_('submit'),
												$elm$html$Html$Events$onClick($author$project$Main$SubmittedForm),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Privacy & Terms')
							])),
						A2(
						$elm$html$Html$a,
						_List_Nil,
