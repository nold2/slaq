					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(model.form.userName)
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
											...
											[
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Attributes$class('input_text'),
														$elm$html$Html$Attributes$value(model.form.userPort),
...
var $author$project$Main$view = function (model) {
	return model.isConnected ? $author$project$Main$chatView(model) : $author$project$Main$loginView(model);
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"EnteredUserName":["String.String"],"EnteredUserPort":["String.String"],"SubmittedForm":[],"ConfirmConnection":["Basics.Bool"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));