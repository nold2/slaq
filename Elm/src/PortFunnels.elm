...
-}
appTrampoline : (String -> (Value -> Cmd msg)) -> GenericMessage -> Funnel model msg -> State -> model -> Result String ( model, Cmd msg )
...
-}
subscriptions : (Value -> msg) -> Sub msg
...
-}
makeFunnelDict : List (Handler model msg) -> (String -> (Value -> Cmd msg)) -> FunnelDict model msg
